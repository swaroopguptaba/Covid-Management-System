...
--------POPULATE USER_LOGIN_AUDIT------------------
    ...
    EXEC INSERTIONS.ADD_USER_LOGIN_AUDIT(4,'Login',sysdate);
    EXEC INSERTIONS.ADD_USER_LOGIN_AUDIT(5,'Login',sysdate);
    
------------POPULATE QUARANTINE FACILITY--------------------
	EXEC INSERTIONS.ADD_QUARANTINE_FACILITY('Boston Quarantine Station',20,1);
    EXEC INSERTIONS.ADD_QUARANTINE_FACILITY('CHA Cambridge Hospital',20,2);
    EXEC INSERTIONS.ADD_QUARANTINE_FACILITY('Baltimore Isolation Center',20,3);
